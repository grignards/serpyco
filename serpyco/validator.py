...
class SerpycoValidator(AbstractValidator):
    def __init__(
        self,
        schema: dict,
        field_validators: typing.Optional[
        ...
        super().__init__(schema, field_validators)
        self._validator = val.Validator(schema, {})

    def validate_json(self, json_string: str) -> None:
        self._validator.validate(rapidjson.loads(json_string))
